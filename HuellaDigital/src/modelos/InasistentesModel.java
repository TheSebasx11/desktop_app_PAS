 ...
 * @author Sebastian
 */
public class InasistentesModel {
    ...
    public InasistentesModel(int inasistencia, int idusuarios, int cargo, String name01, String name02, String lastname01, String lastname02, Date fechaNac, int identificacion, String sexo, String email, int telefono) {
